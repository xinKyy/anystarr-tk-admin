...
const SearchBar = props => {
    ...
    return (
        <Form
                ...
                <Col span={8}>
                    <Form.Item name='status' label='Task status'>
                        <Select allowClear>
                            ...
                            <Option value='2'>Pending for submit</Option>
                            <Option value='3'>Pending for review</Option>
                            <Option value='4'>Review Rejected</Option>
                            <Option value='5'>Sub Process Review Approved</Option>
                            <Option value='6'>Whole Process Review Approved</Option>
                        </Select>
                    </Form.Item>
                </Col>
                <Col span={8}>
            ...
            <Row gutter={24}>
                <Col span={8}>
                    <Form.Item name='business_id' label='Campaign ID'>
                        <Input />
                    </Form.Item>
                </Col>
                <Col span={8}>
                    <Form.Item name='business_type' label='Campaign type'>
                        <Select allowClear>
...
const SearchTableView = props => {
    ...
    const getList = params => {
        ...
        APIGetTaskListNew(getCleanedParams(params))
            .then(resp => {
                setState({
                    ...state,
                    visible: false,
                    list: resp.data.result.records && getKeyList(resp.data.result.records),
                    loading: false,
    ...
    const onCreate = data => {
        ...
        APIModifyRewardAmountNew(params).then(resp => {
    ...
    const edit = data => {
        ...
        var url = webhost + '/task_detail_new/' + data.id
    ...
    return (
        <Layout className='animated fadeIn'>
            ...
            <div className='web-bread-c'>
                ...
                <h3>Task List</h3>
                <a onClick={gotoOldEdition}>Back to old edition</a>
