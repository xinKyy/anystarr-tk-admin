...
const SearchTableView = props => {
    ...
    const getList = params => {
        ...
        APIGetRoles({ roleJson: JSON.stringify(params) })
            .then(resp => {
                setState({
                    ...state,
                    visible: false,
    ...
    const edit = data => {
        console.log('data', data)
        props.history.push('/permissions/addRole/' + data.id)
    }
    ...
    const addRole = () => {
        props.history.push('/permissions/addRole/0')
    }
