...
import {
    ...
    APIGetBrandingCommission,
    APIDownloadBrandingCommission
} from '@/mapi'
...
const SearchTableView = props => {
    ...
    const getList = params => {
        ...
        let apiHref = APIDownloadBrandingCommission()
        let json = JSON.stringify({ ...params })
        let resHref = `${apiHref}?codeCommissionJson=${json}`
        // return  encodeURI(resHref)

        APIGetBrandingCommission({ codeCommissionJson: JSON.stringify(getCleanedParams(params)) })
            .then(resp => {
                setState({
                    ...state,
                    visible: false,
    ...
    return (
        <Layout className='animated fadeIn'>
            ...
            <div className='web-bread-c'>
                <WebBreadcrumb arr={['Branding commission List']} />
                <h3>Branding commission List</h3>
